        ...
        $.SyntaxHighlighter = {
            ...
            load: function() {
                ...
                if (!SyntaxHighlighter.loaded()) {
                    $.appendScript(prettifyBaseUrl + '/../assets/js/lib/prettify.js');
                    $.appendStylesheet(baseUrl + '/../assets/css/prettify.css');
                    $.appendStylesheet(baseUrl + '/../assets/css/prettify/style.css');
                    $.each(themes, function(i, theme) {
                        $.appendStylesheet(baseUrl + '/../assets/css/prettify/theme-' + theme + '.css');
                    });
                    if ($.browser.msie) {
                        $.appendStylesheet(baseUrl + '/../assets/css/prettify/ie.css');
                    }
